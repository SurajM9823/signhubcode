...
from clients.view.client_management_views import (
    client_management, board_types, delete_board_type, municipalities, delete_municipality,
    board_type_rates, delete_board_type_rate, board_type_rate, brands, get_brands,
    get_clients, client_detail, board, get_board, delete_board, get_boards, apply_payment_discount
)
urlpatterns = [
    ...
    # Client Management (Board and Related)
    ...
    path('client-management/board-types/delete/<int:board_type_id>/', delete_board_type, name='delete_board_type'),
    path('client-management/municipalities/', municipalities, name='municipalities'),
    path('client-management/municipalities/delete/<int:municipality_id>/', delete_municipality, name='delete_municipality'),
    path('client-management/board-type-rates/', board_type_rates, name='board_type_rates'),
    path('client-management/board-type-rates/delete/', delete_board_type_rate, name='delete_board_type_rate'),
    path('client-management/board-type-rate/', board_type_rate, name='board_type_rate'),
    ...
    path('client-management/apply-payment-discount/', apply_payment_discount, name='apply_payment_discount'),
